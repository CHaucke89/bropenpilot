...
from openpilot.sunnypilot.selfdrive.controls.lib.longitudinal_mpc_lib.long_mpc_ext import LongitudinalMpcExt
...
class LongitudinalMpc(LongitudinalMpcExt):
  def __init__(self, dt=DT_MDL):
    LongitudinalMpcExt.__init__(self, dt)
    self.dt = dt
  ...
  def reset(self):
    ...
    self.stop_distance = self.get_stop_distance()
    self.set_weights()
